...
--------------------------------------------------------------------------------
-- 상점구역
insert into shop_loc values('AA','인천시', '37.49443088673744', '126.72644033165483');
insert into shop_loc values('BB','관악구', '37.48323023600057', '126.94495606499854');
...
--상품 초기화데이터--
INSERT INTO  item  VALUES ('SD000001','seller04', '맛있는 깻잎장아찌', 4000, '300g', '국산', 5, '깻잎장아찌.jpg', 9.5, '2021-04-11', 5, 'F','sd');
INSERT INTO  item  VALUES ('FR000002','seller02', '상큼한 낑깡', 4000, '500g', '국산', 3, '낑깡.jpg', 9.3, '2021-04-13', 7, 'T','fr');
INSERT INTO  item  VALUES ('BF000003','seller03', '1등급 마블링 한우', 30000, '300g', '국산', 6, '멋진마블링.jpg', 8.7, '2021-04-01', 5, 'F','me');
INSERT INTO  item  VALUES ('VG000004','seller01', '직접키운 대파', 4000, '500g', '국산', 8, '대파.jpg', 8.6, '2021-04-15', 2, 'T','ve');
INSERT INTO  item  VALUES ('RC000005','seller05', '고소한 햇찹쌀', 6000, '1kg', '국산', 7, '찹쌀.jpg', 9.8, '2021-04-01', 3, 'T','ri');
...
--주문 초기화데이터--
INSERT INTO ORDERS VALUES ('A210305000001', '방문수령', '홍길동', null, null, '010-1111-1111', null, 7440, null, 'user01');
...
--주문상세 초기화데이터--
INSERT INTO ORDER_DETAIL VALUES('SD000001', 'A210305000001', 2, 3720);
...
INSERT INTO ORDER_DETAIL VALUES('FR000002', 'T210501000002', 2, 3000);
INSERT INTO ORDER_DETAIL VALUES('RC000005', 'T210501000002', 1, 4000);
INSERT INTO ORDER_DETAIL VALUES('VG000004', 'T210501000003', 1, 5000);
INSERT INTO ORDER_DETAIL VALUES('FR000002', 'T210501000003', 1, 3000);
...
INSERT INTO BOARD VALUES(BOARD_SEQ.NEXTVAL, 'seller02', '[답변]태경이네 과일가게 귤 문의 드려요', '네, 가능합니다. 자세한 사항은 가게로 연락주세요. 상호명:태경이네 과일가게, 연락처: 010-1111-1234', 5, null, '2021-05-01', '3', 'FR000002');

--후기
INSERT INTO REVIEW VALUES(REVIEW_SEQ.NEXTVAL, 'user01', 'FR000002', '2021-05-03', '태경이네 낑깡 추천해요!', '알도 실하고 상큼해서 질리지 않더라구요 다음에는 1키로 살래요 ㅎㅎ', 10.0, null);
--------------------------------------------------------------------------------
-- 장바구니
INSERT INTO CART VALUES('user02','SD000001',3);
INSERT INTO CART VALUES('user02','BF000003',2);
INSERT INTO CART VALUES('user02','VG000004',2);
INSERT INTO CART VALUES('user02','FR000002',3);
--------------------------------------------------------------------------------
commit;