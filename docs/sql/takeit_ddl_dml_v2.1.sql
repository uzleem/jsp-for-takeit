...
INSERT INTO  item  VALUES ('VG'||LPAD(ITEM_SEQ.NEXTVAL,6,'0'),'seller01', '직접키운 대파', 4000, '500g', '국산', 8, 'VG'||LPAD(ITEM_SEQ.CURRVAL,6,'0')||'.jpg', 8.6, '2021-04-29', 2, 'T','ve');
INSERT INTO  item  VALUES ('RC'||LPAD(ITEM_SEQ.NEXTVAL,6,'0'),'seller05', '고소한 햇찹쌀', 6000, '1kg', '국산', 7, 'RC'||LPAD(ITEM_SEQ.CURRVAL,6,'0')||'.jpg', 9.8, '2021-04-01', 3, 'T','ri');

INSERT INTO  item  VALUES ('SD'||LPAD(ITEM_SEQ.NEXTVAL,6,'0'),'seller01', '매그넘', 4000, '300g', '국산', 5, 'SD'||LPAD(ITEM_SEQ.CURRVAL,6,'0')||'.jpg', 9.5, '2021-05-01', 5, 'T','sd');
INSERT INTO  item  VALUES ('FR'||LPAD(ITEM_SEQ.NEXTVAL,6,'0'),'seller03', '마이리틀', 4000, '500g', '국산', 3, 'FR'||LPAD(ITEM_SEQ.CURRVAL,6,'0')||'.jpg', 9.3, '2021-04-30', 7, 'T','fr');
INSERT INTO  item  VALUES ('BF'||LPAD(ITEM_SEQ.NEXTVAL,6,'0'),'seller02', '엔요 요구르트', 30000, '300g', '국산', 6, 'BF'||LPAD(ITEM_SEQ.CURRVAL,6,'0')||'.jpg', 8.7, '2021-04-28', 5, 'T','me');
INSERT INTO  item  VALUES ('VG'||LPAD(ITEM_SEQ.NEXTVAL,6,'0'),'seller05', '직접키운 대파', 4000, '500g', '국산', 8, 'VG'||LPAD(ITEM_SEQ.CURRVAL,6,'0')||'.jpg', 8.6, '2021-04-29', 2, 'T','ve');
INSERT INTO  item  VALUES ('RC'||LPAD(ITEM_SEQ.NEXTVAL,6,'0'),'seller04', '고소한 햇찹쌀', 6000, '1kg', '국산', 7, 'RC'||LPAD(ITEM_SEQ.CURRVAL,6,'0')||'.jpg', 9.8, '2021-04-01', 3, 'T','ri');
...
INSERT INTO CART VALUES('user03','VG000004',2);
