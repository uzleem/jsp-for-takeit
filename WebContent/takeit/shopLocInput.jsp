	...
	<div class="shopLocInput-wrap view-width">
		...
		<table class="shopLocInput-tbl">
			...
			<tr>
				<th>상세주소</th>
				<td>
					<input type="text" placeholder="상세주소" id="addressDetail" class="shopLoc-input" name="addressDetail"/>
				</td>
			</tr>
			<tr>
				<th>상점구역코드</th>
				<td>
					<input type="text" placeholder="상점구역코드" id="shopLocCode" class="shopLoc-input" name="shopLocCode"/>
				</td>
			</tr>
			<tr>
				<th>상점구역이름</th>
				<td>
					<input type="text" placeholder="상점구역이름" id="shopLocName" class="shopLoc-input" name="shopLocName"/>
				</td>
			</tr>
		</table>
