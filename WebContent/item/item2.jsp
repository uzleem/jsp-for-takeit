		...
		<div id="enroll_total">
			<div style="display: flex;">
				<div style="width: fit-content;">
					<img alt='맛간장' src="/takeit/img/item/item2.jpg" width="450"
						height="310">
				...
				<div id="meat_div" style="width: fit-content;">
					...
					<hr class="line1">
					<div>
						<span> 카테고리 </span> &nbsp; <span> 조미료</span>
					</div>

					<div>
						<span> 판매단위 </span> &nbsp; <span> 500g </span>
					</div>
					<div>
					...
					<div>
						<span> 포장타입 </span>&nbsp; <span>상온포장</span>
					</div>
					<div>
						<span> 판매자</span> &nbsp; <span> 미자언니네</span>
					</div>
					<div>
						<span> 고객평점 </span> &nbsp; <span> 9.5점 </span>
					</div>
					<div>
