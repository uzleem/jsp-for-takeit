...
public class Seller implements Serializable{	
	...
	public Seller(String sellerId, String sellerPw, String name, String mobile, String email, String entryDate,
			String postNo, String address, String grade, String sellerNo, String shopMobile, String shopName,
			double custScore, String shopKakaoId, String shopImg, String shopCategoryNo, String shopLocCode) {
		this.sellerId = sellerId;
		this.sellerPw = sellerPw;
		this.name = name;
		this.mobile = mobile;
	...
	public String toString() {
		return "Seller [sellerId=" + sellerId + ", sellerPw=" + sellerPw + ", name=" + name + ", mobile=" + mobile
				...
				+ ", grade=" + grade + ", sellerNo=" + sellerNo + ", shopMobile=" + shopMobile + ", shopName="
				+ shopName + ", custScore=" + custScore + ", shopKakaoId=" + shopKakaoId + ", shopImg=" + shopImg
				+ ", shopCategoryNo=" + shopCategoryNo + ", shopLocCode=" + shopLocCode + "]";
	}
